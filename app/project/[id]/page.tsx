...
export default function ProjectDashboardPage() {
      ...
      try {
        ...
        if (projectRes.success && projectRes.data) {
          ...
          const checkIsMember = 
            ...
            projectData.projectApplications?.some((app: any) => app.user.id === userId);
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      case 'dashboard':
        return <div className={styles.fullCard}><Dashboard project={project} events={events}/></div>;
      case 'calendar':
        return (
          <div className={styles.fullCard}>
            <CalendarView project={project} events={events} setEvents={setEvents} />
          </div>
        );
      case 'chat':
        return (
